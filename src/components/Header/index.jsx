  ...
  if (email2 && token) {
    return (
      <>
        ...
        <Container>
          <Navbar.Brand className="mt-1 width-150px height-100px ">
            <img src="/images/Home/img_logo.png" alt="logo" />
          </Navbar.Brand>
          ...
          >
            ...
            <Offcanvas.Body className="justify-content-end">
              <Nav >
                <Nav.Link className="me-2" href="#OurServices">Layanan Internet</Nav.Link>
                <Nav.Link className="me-2" href="#WhyUs">CCTV</Nav.Link>
